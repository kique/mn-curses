...
OPTIONS = -O2 -ggdb -Wall -lm -lncurses -lplplotd # -g for debug, -O2 for optimise and -Wall additional messages
INCLUDES = -I/usr/include/plplot # Directory for header file
FUENTES=main.c int_newton.c funciones.c menu.c raices-cerrados.c entrada_raices.c raices-abiertos.c grafica.c
#FUENTES=%.c

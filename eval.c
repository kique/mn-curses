 ...
 *       Filename:  eval.c
 *
 *    Description:  Ejemplo de evaluacion de expresiones
 *
 *        Version:  1.0
 *        Created:  09/12/13 22:29:24
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
/* Se instalaron los paquetes libmatheval.x86_64 y libmatheval-devel.x86_64 en fedora 19*/
